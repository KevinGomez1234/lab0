...
To run use the make command and it will create an executable called ./lab0. This program reads a sequence of 1's and 0's from the stdin or a file with text in the current directory.
